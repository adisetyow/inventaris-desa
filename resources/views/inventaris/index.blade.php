        ...
        <div class="card modern-card">
            <div class="card-header">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    ...
                    <div class="card-header-actions d-flex flex-wrap justify-content-end align-items-center gap-2">
                        <form method="GET" action="{{ route('inventaris.index') }}" 
                        class="search-form flex-grow-1 me-2 " id="searchForm" style="max-width: 200px;">
                                ...
                                <tr>
                                    <td colspan="7">
                                        ...
                                        <div class="text-center py-5">
                                            ...
                                            <p class="text-slate-400">Tidak ada data yang cocok dengan kriteria pencarian Anda.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
